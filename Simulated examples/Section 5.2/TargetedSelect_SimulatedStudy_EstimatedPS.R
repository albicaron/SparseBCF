...
### INFO
N = 1000
P = 10  # We tried P = 10 and P = 20 to see how the problem degenerate
B = 500
...
write.csv(Bias_Final,
          paste0("YOUR DIRECTORY/EstimatedPSversion_ConfExam_FinalBias_B", B, "_P", P, ".csv"))

write.csv(PEHE_Final,
          paste0("YOUR DIRECTORY/EstimatedPSversion_ConfExam_FinalPEHE_B", B, "_P", P, ".csv"))

write.csv(Cover_Final,
          paste0("YOUR DIRECTORY/EstimatedPSversion_ConfExam_FinalCoverage_B", B, "_P", P, ".csv"))

write.csv(Split_Proba,
          paste0("YOUR DIRECTORY/EstimatedPSversion_ConfExam_SplitProba_B", B, "_P", P, ".csv"))
