...
get_features <- function(N, P) {
  ...
  X = matrix(NA, N, P)
  X[, 1:20] = qnorm(unif[, 1:20])
  X[, 21:P] = qbinom(unif[, 21:P], 1, 0.3)
...
write.csv(PEHE_Final,
          paste0(curr_dir, "/Results/PEHE_Final_P50.csv"))


write.csv(PEHE_Single,
          paste0(curr_dir, "/Results/PEHE_Single_P50.csv"))


write.csv(Split_Final,
          paste0(curr_dir, "/Results/Split_Final_P50.csv"))
