...
#else
   friend bool bd(tree& x, xinfo& xi, dinfo& di, pinfo& pi, std::vector<size_t>& nv_s, std::vector<double>& pv, RNG& gen);
   //my functions
   friend bool bd_rj(tree& x, xinfo& xi, dinfo& di, pinfo& pi, RNG& gen);
   friend bool bdprec(tree& x, xinfo& xi, dinfo& di, pinfo& pi, RNG& gen);
   friend bool bdhet(tree& x, xinfo& xi, dinfo& di, double* phi, pinfo& pi, std::vector<size_t>& nv_s, std::vector<double>& pv, RNG& gen);
